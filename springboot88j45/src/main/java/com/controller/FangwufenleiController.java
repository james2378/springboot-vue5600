...
public class FangwufenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FangwufenleiEntity fangwufenlei,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FangwufenleiEntity fangwufenlei, 
		HttpServletRequest request){
        EntityWrapper<FangwufenleiEntity> ew = new EntityWrapper<FangwufenleiEntity>();
