	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="房屋分类" prop="fangwufenlei">
					<el-select :disabled="ro.fangwufenlei" v-model="ruleForm.fangwufenlei" placeholder="请选择房屋分类" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房屋分类" prop="fangwufenlei">
					<el-input v-model="ruleForm.fangwufenlei"
						placeholder="房屋分类" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房屋设施" prop="fangwusheshi">
					<el-input v-model="ruleForm.fangwusheshi" placeholder="房屋设施" clearable  :readonly="ro.fangwusheshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房屋设施" prop="fangwusheshi">
					<el-input v-model="ruleForm.fangwusheshi" placeholder="房屋设施" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="房屋介绍" prop="fangwujieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.fangwujieshao" label="房屋介绍" prop="fangwujieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fangwujieshao"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/fangwufenlei/fangwufenlei`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.fangwufenleiOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fangwujieshao = this.ruleForm.fangwujieshao.replace(reg,'../../../springboot88j45/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
