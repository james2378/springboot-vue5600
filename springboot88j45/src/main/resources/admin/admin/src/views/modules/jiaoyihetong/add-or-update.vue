<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房屋名称" prop="fangwumingcheng">
					<el-input v-model="ruleForm.fangwumingcheng" placeholder="房屋名称" clearable  :readonly="ro.fangwumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房屋名称" prop="fangwumingcheng">
					<el-input v-model="ruleForm.fangwumingcheng" placeholder="房屋名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房屋分类" prop="fangwufenlei">
					<el-input v-model="ruleForm.fangwufenlei" placeholder="房屋分类" clearable  :readonly="ro.fangwufenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房屋分类" prop="fangwufenlei">
					<el-input v-model="ruleForm.fangwufenlei" placeholder="房屋分类" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房屋号" prop="fangwuhao">
					<el-input v-model="ruleForm.fangwuhao" placeholder="房屋号" clearable  :readonly="ro.fangwuhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房屋号" prop="fangwuhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房屋价格" prop="fangwujiage">
					<el-input v-model="ruleForm.fangwujiage" placeholder="房屋价格" clearable  :readonly="ro.fangwujiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="房屋价格" prop="fangwujiage">
					<el-input v-model="ruleForm.fangwujiage" placeholder="房屋价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.qiandinghetong" label="签订合同" prop="qiandinghetong">
					<file-upload
						tip="点击上传签订合同"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qiandinghetong" label="签订合同" prop="qiandinghetong">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.qiandinghetong)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.qiandinghetong" label="签订合同" prop="qiandinghetong">
...
export default {
	...
	if(this.ruleForm.qiandinghetong!=null) {
		this.ruleForm.qiandinghetong = this.ruleForm.qiandinghetong.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoyihetong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoyihetongCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    qiandinghetongUploadChange(fileUrls) {
	    this.ruleForm.qiandinghetong = fileUrls;
    },
  }
};
</script>
